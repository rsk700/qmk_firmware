...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_DELT,        KC_Q,         KC_W,   KC_E,   KC_R,   KC_T,   KC_MINS,
        KC_BSPC,        KC_A,         KC_S,   KC_D,   KC_F,   KC_G,
        KC_LSFT,        CTL_T(KC_Z),  KC_X,   KC_C,   KC_V,   KC_B,   LCAG_T(KC_NO),
        LT(SYMB,KC_HOME),KC_END,      LALT(KC_LSFT),  KC_LEFT,KC_RGHT,
                                              KC_LALT,        KC_LCTL,
                                                              RCTL(KC_C),
                                               KC_SPC,KC_BSPC,RCTL(KC_V),
        // right hand
             KC_RGHT,     KC_6,   KC_7,   KC_8,   KC_9,   KC_0,             LT(MDIA, KC_MUTE),
             KC_EQL,      KC_Y,   KC_U,   KC_I,   KC_O,   KC_P,             KC_BSLS,
                          KC_H,   KC_J,   KC_K,   KC_L,   KC_SCLN,          KC_QUOT,
             KC_GRV,      KC_N,   KC_M,   KC_COMM,KC_DOT, CTL_T(KC_SLSH),   KC_RSFT,
...
[SYMB] = KEYMAP(
       ...
       KC_TRNS,KC_CAPS,KC_NLCK,KC_LCBR,KC_RCBR,KC_TRNS,KC_TRNS,
       ...
       KC_TRNS, KC_AMPR, KC_P1,  KC_P2,   KC_P3,   KC_PAST, KC_PSCR,
                         KC_P0,KC_PDOT,   KC_TRNS, KC_PSLS, KC_TRNS,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS
),
...
[GAME] = KEYMAP(
       ...
       KC_TRNS, KC_TRNS, KC_TRNS, KC_LALT, KC_LCTRL,
                                            KC_ESC, KC_TRNS,
                                                    KC_TRNS,
                                  KC_TRNS, KC_TRNS, KC_TRNS,
    // right hand
